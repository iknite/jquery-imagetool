  ...
  $.fn.extend({
    ...
    store: function(settings) {
      ...
      if(typeof settings.callback == 'function') {
        settings.callback(parseInt(dim.topX, 10), parseInt(dim.topY, 10), parseInt(dim.bottomX, 10), parseInt(dim.bottomY, 10));
      }      
    }
   ...
   ,move: function(settings) {    
      ...
      ,resize: function(settings) {
       ...
       if(settings.width < settings.viewportWidth) {
         settings.height = parseInt(settings.imageHeight * (settings.viewportWidth/settings.imageWidth), 10);
       ...
       if(settings.height < settings.viewportHeight) {
         settings.width = parseInt(settings.imageWidth * (settings.viewportHeight/settings.imageHeight), 10);
      ...
      if(settings.width > settings.imageMaxWidth) {
         settings.height = parseInt(settings.height * (settings.imageMaxWidth/settings.width), 10);
    ...
    ,imagetool: function(settings) {
      ...
      return this.each(function() {
        ...
        image.load(function() {
          ...
          //alert("image is " + this.width + " by " + this.height + " pixels in size.");
